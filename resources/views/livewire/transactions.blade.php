                                                            ...
                                                            <div class="d-flex w-100">
                                                                <div class="w-100">
                                                                    <p class="ficon m-0 w-100 lh1_3 text-start mb-1 pointer" x-on:click="$store.data.toggleTransaction('timeline',{{ $transaction['id'] }})">
                                                                        ...
                                                                        <span class="mb-1 fw-bold text-dark d-block fs-14">@if(App\Helpers\Functions::not_empty($transaction['remit_info_unstructured'])){{ $transaction['remit_info_unstructured'] }} @else {{ $transaction['remittance_information_structured'] }} @endif<span><i id="transaction_timeline_icon_{{ $transaction['id'] }}" x-bind:class="$store.data.is_expanded({{ $transaction['id'] }}) ? 'uil-arrow-up' : 'uil-arrow-down'" class="uil v-middle fs-20 text-muted"></i></span></span>
                                                                    </p>
                                                                    ...
                                                                    <div x-bind:class="$store.data.is_expanded({{ $transaction['id'] }}) ? 'transaction_expanded' : 'transaction_collapsed'" class="text-start mb-1 transaction_timeline_{{ $transaction['id'] }}">
                                                                        ...
                                                                        @if(App\Helpers\Functions::not_empty($transaction['debator_name']) || App\Helpers\Functions::not_empty($transaction['debtor_account']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1 mb-lg-0"><div class="col-md-12 col-lg-5 lh1_3 p-0"><small><strong>Debator:</strong></small></div> <div class="col-md-12 col-lg-7 lh1_3 p-0">@if(App\Helpers\Functions::not_empty($transaction['debator_name'])) {{ $transaction['debator_name'] }} @endif @if(App\Helpers\Functions::not_empty($transaction['debtor_account'])) (<small>{{ $transaction['debtor_account'] }}</small>) @endif </div> </div>@endif
                                                                        ...
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remittance_information_structured']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Structured:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"> {{ $transaction['remittance_information_structured'] }}</div></div>@endif
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remittance_information_structured_array']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Structured Array:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"> {{ $transaction['remittance_information_structured_array'] }}</div></div>@endif
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remit_info_unstructured']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Unstructured:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"> {{ $transaction['remit_info_unstructured'] }}</div></div>@endif
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remittance_information_unstructured_array']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Unstructured Array:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"> {{ $transaction['remittance_information_unstructured_array'] }}</div></div>@endif
                                                                ...
                                                                <div class="d-flex w-20 align-items-end flex-column justify-content-between">
                                                                    <p class="ficon mb-0 fw-bold fs-14 text-primary">{{ $transaction['transaction_currency'] }} {{ $transaction['transaction_amount'] }}</p>
                            ...
                            <div class="list-group w-100">
                                <div class="d-flex w-100 ">
                                    <div class="ficon m-0 w-100 text-start t2_para" >
                                        {{-- <small class="text-muted fw-normal fs-11">12:02:46 PM</small> --}}
                                        <span class="d-block fw-bold text-dark fs-14 pointer" x-on:click="$store.data.toggleTransaction('timeline_2',{{ $transaction['id'] }})">@if(App\Helpers\Functions::not_empty($transaction['remit_info_unstructured'])){{ $transaction['remit_info_unstructured'] }} @else {{ $transaction['remittance_information_structured'] }} @endif <span><i id="transaction_timeline_2_icon_{{ $transaction['id'] }}" x-bind:class="$store.data.is_expanded({{ $transaction['id'] }}) ? 'uil-arrow-up' : 'uil-arrow-down'" class="uil v-middle fs-18 text-muted"></i></span></span>
                                    ...
                                    <div class="d-flex w-20 align-items-end flex-column">
                                        <p class="ficon mb-0 text-primary fs-14 fw-bold">{{ $transaction['transaction_currency'] }} {{ $transaction['transaction_amount'] }}</p>
