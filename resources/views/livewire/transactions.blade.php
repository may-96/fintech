                                                            ...
                                                            <div class="d-flex w-100">
                                                                <div class="w-100">
                                                                    ...
                                                                    <div x-bind:class="$store.data.is_expanded({{ $transaction['id'] }}) ? 'transaction_expanded' : 'transaction_collapsed'" class="text-start mb-1 transaction_timeline_{{ $transaction['id'] }}">
                                                                        ...
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remit_info_unstructured']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Unstructured:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"><pre style="font-family: 'Manrope', sans-serif;white-space: pre-wrap;" class="p-0">{{ $transaction['remit_info_unstructured'] }}</pre></div></div>@endif
                                                                        @if(App\Helpers\Functions::not_empty($transaction['remittance_information_unstructured_array']))<div class="w-100 text-dark fs-14 text-start row m-0 mb-1"><div class="col-12 col-lg-5 lh1_3 p-0"><small><strong>Remittance Information Unstructured Array:</strong> </small></div><div class="col-12 col-lg-7 lh1_3 p-0"><pre style="font-family: 'Manrope', sans-serif;white-space: pre-wrap;" class="p-0">{{ $transaction['remittance_information_unstructured_array'] }}</pre></div></div>@endif
