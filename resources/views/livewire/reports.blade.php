                ...
                <div class="container bg-gray pt-11 px-4">
                    <div class="row mb-15">
                        ...
                        <div class="col-lg-4 col-md-12 mh-100">
                            <div class="p-3 border bg-gradient-dark shadow-lg d-flex justify-content-around align-items-center rounded">
                                <div class="col-12">
                                    <h3 class="d-flex justify-content-between fs-28 text-red"><span>{{ $report_data[16] . ' ' . round($report_data[6], 2) }}</span><i
                                           class="uil uil-briefcase fs-20 text-red border bg-white rounded-full px-2 py-1"></i></h3>
                                                            ...
                                                            @foreach ($streak as $streak_index => $val)
                                                                @if($streak_index > 1)
                                                                    ...
                                                                    <div class="d-flex justify-content-between border-bottom p-1">
                                                                        ...
                                                                        <span><pre style="font-family: 'Manrope', sans-serif;white-space: pre-wrap;word-break: break-word; overflow-wrap: break-word; line-break: anywhere;" class="p-0 ficon m-0 w-100 lh1_3 text-start pointer mb-1 fw-bold text-dark d-block fs-14">@if(App\Helpers\Functions::not_empty($val['remit_info_unstructured'])) {!! nl2br($val['remit_info_unstructured']) !!} @elseif(App\Helpers\Functions::not_empty($val['remittance_information_unstructured_array'])) {!! nl2br(implode("\n",json_decode($val['remittance_information_unstructured_array']))) !!} @elseif(App\Helpers\Functions::not_empty($val['remittance_information_structured'])) {!! nl2br($val['remittance_information_structured']) !!} @elseif(App\Helpers\Functions::not_empty($val['remittance_information_structured_array'])) {!! nl2br(implode("\n",json_decode($val['remittance_information_structured_array']))) !!} @endif</pre></span>
