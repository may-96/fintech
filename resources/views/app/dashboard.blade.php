                    ...
                    <div class="card flex-row p-4 justify-content-start justify-content-md-around" style="background: #ee7a3f;">
                        <div class="col-lg-6 d-flex flex-column justify-content-around text-white">
                            ...
                            <div class="animated-caption" data-anim="animate__slideInUp" data-anim-delay="1000">
                                ...
                                <br />
                                <a href="{{route('reports.i.shared')}}" class="btn btn-lg py-0 btn-outline-white text-indigo rounded-pill my-1" title="Reports I Shared">Reports I Shared</a>
                                <a href="{{route('shared.reports')}}" class="btn btn-lg py-0 btn-outline-white text-indigo rounded-pill my-1" title="View Reports Shared with Me">Reports Shared With Me</a>
                            </div>
                        </div>
                        <!--/column -->
