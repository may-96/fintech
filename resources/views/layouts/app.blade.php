                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <input name="credit_score_notification" id="credit_score_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="credit_score_notification">Can View Credit Score</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="cash_flow_notification" id="cash_flow_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="cash_flow_notification">Can View Cash Flow</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="expenses_notification" id="expenses_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="expenses_notification">Can View Expenses</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="income_notification" id="income_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="income_notification">Can View Income</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="email_check_notification" id="email_check_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="email_check_notification">Can View Email</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="contact_notification" id="contact_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="contact_notification">Can View Contact #</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="initials_only_notification" id="initials_only_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
                            <label class="form-check-label mb-2 fs-14 text-start" for="initials_only_notification">Initials of the Name</label>
                        </div>
                        <div class="col-12 col-sm-6">
                            <input name="account_initials_only_notification" id="account_initials_only_notification" type="checkbox" class="p-1 mb-2 form-check-input" checked>
