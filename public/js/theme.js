    ...
    var theme = {
        ...
        dropdownAnimation: () =>
        {
            $('.navbar .navbar-nav:not(.navbar-nav-other)')
                ...
                {
                    $(this)
                        .removeClass('show-animation hide-animation');
                    e.stopPropagation();
                });
        },
        /**
        ...
        isotope: () =>
        {
            ...
            $('.grid')
                .each(function(i, gridContainer)
                {
                    ...
                    var $grid = $gridContainer.find('.isotope')
                    ...
                    $gridContainer.find('.isotope-filter')
                        .on('click', 'a', function()
                        {
        ...
        onepageHeaderOffset: () =>
        {
            var header_height = $('.navbar:not(.banner--clone)')
                .outerHeight();
            ...
            $('.hero-slider')
                .each(function()
                {
                    ...
                    $hslider.on("changed.owl.carousel", e =>
                    {
                        ...
                        var $currentOwlItem = $(".owl-item")
                            .eq(e.item.index);
                        $currentOwlItem.find(".animated-caption")
                            .each(function(index, value)
                            {
                                var a = $(this)
                                    .data("anim-delay");
        ...
        animatedCaptions: () =>
        {
            ...
            $animatedCaptions.find(".animated-caption")
                .each(function()
                {
                    var a = $(this)
                        .data("anim-delay");
        ...
        bsModal: () =>
        {
            ...
            myModalEl.forEach(myModalEl =>
            {
                ...
                {
                    $('.navbar.fixed')
                        .css('padding-right', pad_right);
                    $('.progress-wrap')
                        .css('margin-right', pad_right);
                })
        ...
        pricingSwitcher: () =>
        {
            $('.pricing-wrapper')
                .each(function(i, container)
                {
                    ...
                    $container.find(".pricing-switcher")
                        .on('click', function()
                        {
                            $container.find(".pricing-switcher")
                                .toggleClass('pricing-switcher-active');
                            $container.find(".price")
                                .removeClass('price-hidden');
                            $container.find(".price")
                                .toggleClass('price-show price-hide');
                        });
                });
        },
        /**
